...
- Works in 2025
- Weakly releases
- [Fully automated via GitHub actions](https://github.com/hr0ark/artix-rootfs/actions/workflows/ci.yml)
...
- Download the latest Artix base/server rootfs tarball (main purpose of this repo is maintaing of this tarball):
  <br>[`https://github.com/hr0ark/artix-rootfs/releases/latest/download/artix_rootfs.tar.xz`](https://github.com/hr0ark/artix-rootfs/releases/latest/download/artix_rootfs.tar.xz)
...
- Download the script:
  ```bash
  wget https://raw.githubusercontent.com/hr0ark/main/get.sh
  ```
- Run it:
  ```bash
  bash get.sh 1 1
...
- Start a new Powershell session:
  ...
  <br><br>![image 1](https://github.com/hr0ark/artix-rootfs/assets/172701622/caca3084-fd1a-4feb-8e1b-a5226975940f)
...
- Create sources directory:
  ...
  ```
  ![image 2](https://github.com/hr0ark/artix-rootfs/assets/172701622/b5baa742-864c-44e7-b61c-fc9dc3c66e04)
...
- Copy (or move) the `artix_rootfs.tar.xz` to the `/wsl_distros/sources/` directory:
  ...
  ```
  ![image 3](https://github.com/hr0ark/artix-rootfs/assets/172701622/243f0848-80d1-4b91-99c6-f06073a854ff)
...
- Register Artix as a new WSL distro:
  ...
  ```
  ![image 4](https://github.com/hr0ark/artix-rootfs/assets/172701622/bbeae98b-3b48-4c1d-ab60-b5f8f00558c1)

- Ensure the distro has been imported correctly:
  ```bash
  wsl.exe --list --verbose
  ```
  ![image 5](https://github.com/hr0ark/artix-rootfs/assets/172701622/4777ac9b-6025-416b-b9fa-0421adce362c)
...
- Create on your desktop shortcut with path:
  ...
  <br>`Artix`
  <br><br>Recomended:
    - Change icon in Properties to [`https://raw.githubusercontent.com/hr0ark/artix-rootfs/main/artix_logo.ico`](https://raw.githubusercontent.com/hr0ark/artix-rootfs/main/artix_logo.ico)

- Run it

  ![image 6](https://github.com/hr0ark/artix-rootfs/assets/172701622/1d8860c9-8baa-4e43-abe2-f7bb1d982b53)
...
- Run it
  ...
  ![image 7](https://github.com/hr0ark/artix-rootfs/assets/172701622/8fe895a4-557e-48b6-8c83-057b1bcf11cb)
...
- Was decided to use [GitHub Action](https://github.com/hr0ark/artix-rootfs/blob/main/.github/workflows/ci.yml) 
